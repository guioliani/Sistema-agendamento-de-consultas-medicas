...
$idConsulta = $_GET['id'];
$select = $mysqli->query("SELECT * FROM agenda WHERE id = '$idConsulta'");
$row = $select->num_rows;
...
$valor_cobrado = $get['valor']; // Valor - REGRA: Sem pontos na milhar e tanto faz com "." ou "," ou com 1 ou 2 ou sem casa decimal
...
$dadosboleto["cpf_cnpj"] = "4945645136";
$dadosboleto["endereco"] = "Coloque o endereço da sua empresa aqui";
$dadosboleto["cidade_uf"] = "São Paulo / São Paulo";
$dadosboleto["cedente"] = "DrWeb";
